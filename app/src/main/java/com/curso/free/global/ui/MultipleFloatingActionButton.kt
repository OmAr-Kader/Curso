...
import com.curso.free.global.base.backGreyTrans
...
fun MultiFloatingActionButton(
    ...
    val curveColor = isSystemInDarkTheme().backGreyTrans
...
fun SmallFloatingActionButtonRow(
    ...
    Row(
        ...
        ExtendedFloatingActionButton(
            text = { Text(text = item.label, color = isSystemInDarkTheme().textForPrimaryColor) },
            onClick = {
